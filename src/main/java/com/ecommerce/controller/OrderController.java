...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<OrderDetailResponse>> createOrder(
        ...
        try {
            ...
            ApiResponse<OrderDetailResponse> errorResponse = (ApiResponse<OrderDetailResponse>) (Object) ApiResponse
    ...
    public ResponseEntity<ApiResponse<Page<OrderListResponse>>> getMyOrders(
        ...
        try {
            ...
            @SuppressWarnings("unchecked")
            ApiResponse<Page<OrderListResponse>> errorResponse = (ApiResponse<Page<OrderListResponse>>) (Object) ApiResponse
                    .error(400, e.getMessage());
            return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
        }
    }
    ...
    public ResponseEntity<ApiResponse<OrderDetailResponse>> updateOrderStatus(
        ...
        try {
            ...
            log.info("Cập nhật trạng thái đơn: orderId={}, sellerId={}, status={}", orderId, sellerId,
                    request.getStatus());
    ...
    public ResponseEntity<ApiResponse<List<OrderStatusHistoryResponse>>> getOrderStatusHistory(
        ...
        try {
            ...
            @SuppressWarnings("unchecked")
            ApiResponse<List<OrderStatusHistoryResponse>> errorResponse = (ApiResponse<List<OrderStatusHistoryResponse>>) (Object) ApiResponse
                    .error(400, e.getMessage());
            return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
        }
    }
